...
map_name <- paste0(datadir,"diaf_00_2016_provinces.tif")
rp_name  <- paste0(datadir,"sae_design_diaf_00_2016_provinces/manual_sampling.csv")


############# IL FAUT LANCER L'APPLI ET CONTINUER
map <- raster(map_name)
rp  <- read.csv(rp_name)
...
write.csv(df,paste0(datadir,"sae_design_diaf_00_2016_provinces/manual_selection_20210606.csv"),row.names = F)
write.csv(df[,c("LON","LAT","PLOTID")],paste0(datadir,"sae_design_diaf_00_2016_provinces/ceo_manual_selection_20210606.csv"),row.names = F)
