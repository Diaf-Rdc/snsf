...
areadir <- paste0(datadir,"cartes/area/")
dir.create(areadir,showWarnings = F)

bdd_dir <- paste0(datadir,"bdd/")
dir.create(bdd_dir,showWarnings = F)
...
sim0010dir <- paste0(datadir,"emissions/simulations_emissions_00_10/")
dir.create(sim0010dir,showWarnings = F)

sim1014dir <- paste0(datadir,"emissions/simulations_emissions_10_14/")
dir.create(sim1014dir,showWarnings = F)

sim1416dir <- paste0(datadir,"emissions/simulations_emissions_14_16/")
dir.create(sim1416dir,showWarnings = F)
