...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(res_dir,"tmp_results_magnitude_pct.tif"),
               paste0(res_dir,"results_rdc_threshold.tif")
))
...
#################### CANEVAS
mask   <- paste0(res_dir,"results_rdc_threshold.tif")
...
#################### ALIGN
thresh  <- paste0(res_dir,"results_rdc_threshold.tif")
...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(res_dir,"tmp_map_bfast_pct.tif"),
               paste0(res_dir,"results_rdc_map.tif")
))
