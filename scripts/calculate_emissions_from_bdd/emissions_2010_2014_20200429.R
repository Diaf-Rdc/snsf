...
df0 <- read.csv2(paste0(sim1014dir,"sim_bd/bd_simulation_28_2010_2014_20200403.csv"))
...
write.csv(df0,paste0(bdd_dir,"bd_filled_simulation_28_2010_2014_20200423.csv"))
...
for(province in unique(ar$NOM)){
  ...
  write.csv(d1,paste0(sim1014dir,"sim_em/em_",province,"_1014.csv"),row.names = F)
...
write.csv2(dd,paste0(sim1014dir,"emissions_renf_2010_2014_20200429.csv"),row.names = F)
